# Editor's drafts for resumable-upload/media-type branch of [httpwg/http-extensions](https://github.com/httpwg/http-extensions/tree/resumable-upload/media-type)
